...
preprocessing = {
    ...
    'protected_phrases_file': os.path.join(package_path, 'configs/protected_phrases.txt'),

    # file with blacklisted answers
    'answers_blacklist_file': os.path.join(package_path, 'configs/answers_blacklist.txt'),

    # file with detokenizer rules
    'answers_detokenize_file': os.path.join(package_path, 'configs/answers_detokenize.txt'),

    # file with replace rules for answers
    'answers_replace_file': os.path.join(package_path, 'configs/answers_replace.txt'),

    # file with blacklisted answers
    'vocab_blacklist_file': os.path.join(package_path, 'configs/vocab_blacklist.txt'),

    # file with replace rules for vocab
    'vocab_replace_file': os.path.join(package_path, 'configs/vocab_replace.txt'),
